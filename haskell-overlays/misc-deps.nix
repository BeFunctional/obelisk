...
in {
  ...
  hpack =
    super.hpack.overrideScope (self: super: { Cabal = self.Cabal_3_2_0_0; });
  ...
  test-framework =
    haskellLib.dontCheck (self.callHackage "test-framework" "0.8.2.0" { });
  hnix = haskellLib.dontCheck (self.callHackage "hnix" "0.8.0" { });
  hpack = haskellLib.dontCheck (self.callHackage "hpack" "0.33.1" { });
  ...
  snap-core = haskellLib.dontCheck
    (self.callCabal2nix "snap-core" (hackGet ../dep/snap-core) { });

  logging-effect =
    self.callCabal2nix "logging-effect" (hackGet ../dep/logging-effect) { };
  ...
  unliftio-core = self.callHackage "unliftio-core" "0.2.0.1" { };
  data-fix = self.callHackage "data-fix" "0.2.1" { };
}
